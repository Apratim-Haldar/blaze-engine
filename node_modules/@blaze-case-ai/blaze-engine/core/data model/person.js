module.exports = {
  ...
  attributes: [
    ...
    { 
      id: 'bsn',        type: 'string', label: 'BSN',
      validations: { pattern: '^[0-9]{9}$', errorMessage: '9 digits' },
      unique: true
    },
    { 
      id: 'countryCode', type: 'string', label: 'Country Code',
      defaultValue: '+31', allowedValues: ['+1','+31','+44','+91']
    },
    { 
      id: 'phoneNumber', type: 'string', label: 'Phone Number',
      controlType: 'tel',
      validations: { pattern: '^[0-9]{7,15}$', errorMessage: '7-15 digits' },
      displayProps: { prefix: 'countryCode' }
    },
    {
      id: 'address',
      type: 'reference',
      ...
      component: 'address-details',   // web‐component tag
